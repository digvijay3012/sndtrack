 ...
 */
$config['site_title']                 = "sndtrack.stagingdevsite.com";       // Site Title, example.com
$config['admin_email']                = "sndtrack@sndtrack.stagingdevsite.com"; // Admin Email, admin@example.com
$config['default_group']              = 'artist';           // Default group, use name
