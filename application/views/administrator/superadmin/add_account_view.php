...
<body>
    <div class="login_cont text-center">
		...
		echo form_open('administrator/add_account', $attributes); ?>
            ...
            <ul>
                ...
                <li>
                    <button class="custom-button full-width" type="submit" id="send" name="submit" required="">Create Admin Account</button>
                </li>
            </ul>
    <?php echo form_close();?>
    </div>
