...
<body>
    <div class="login_cont text-center">
        ...
        <?php 
			if(!empty($page_data)){
				foreach($page_data as $getPageData){
					$pageId				=	$getPageData['id'];
					$page_title			=	$getPageData['page_title'];
					$page_content		=	$getPageData['page_content'];
				}
			}else{
					$pageId				=	'';
					$page_title			=	'';
		...
		echo form_open_multipart('administrator/pages/edit_page', $attributes); ?>
		<ul>
			<li>
			<input type="text" name="page_title" placeholder="Page Title" maxlength="50" value="<?php echo $page_title; ?>">
				<input type="hidden" name="page_id"  value="<?php echo $pageId; ?>">
			</li>
			<li>
				<textarea name="page_content" class="edit"><?php echo $page_content; ?></textarea>
			 </li>
		 </ul>
		 <li>
