<div class="cstmr_cont header-margin">
        <div class="music-bar">
            <figure><img src="images/music-bar.jpg" alt="" title=""></figure>
        </div>
        <div class="container-fluid pdngg container-full">
            ...
            <div class="rt_sidebar browse-page">
                <div class="cont_artist">
                    <div class="lft_browse pull-left">
                        <div class="order_list">
                            <div class="ordr_tabs">
                                <ul>
                                    ...
                                    <li>
                                        <button class="active" type="button">Trending</button>
                                    </li>
                                    <li>
                                        <button type="button">Longest</button>
                                    </li>
                                    <li>
                                        <button type="button">Shortest</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="ordr_inner">
                                <img src="images/browse-song-img.jpg" alt="" title="">
                            </div>
                        </div>
                    </div>
                    <div class="rgt_browse pull-right">
                        <div class="browse-right-box">
                            <h3>Clem Snide</h3>
                            <figure><img src="images/browse-page-img.jpg" alt="" title=""></figure>
