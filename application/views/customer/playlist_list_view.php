        ...
        <div class="modal fade" id="playlistModal" role="dialog">
			...
			<div id="add_to_wishlist_msg"></div>
                <div class="cont_artist">
                    <div class="wishlists-bar">
                        <h3>Playlist</h3>
                        <div class="wishlists-client"><?php echo get_playlist_name_by_id($getPlaylist_id); ?></div>
                    </div>
           ...
           <div class="ordr_inner">
				...
				<table class="table loop_table">
					<thead></thead>
						<tbody>
						<?php $getAllMusic	=	get_customer_playlist_music($customerId,$playListId); 
...
$(document).on('click','.short_order',function(){
	...
	var playListId	=	'<?php echo $getPlaylist_id; ?>';
	$('.draggable').draggable();
	var url	=	'<?php echo base_url(); ?>playlist/filter_by_playlist_orderby/'+playListId+"/"+short_type;
