...
(function($) {
        ...
        this.each(function() {
            ...
            function generate_wave_data(pargs) {
                ...
                wavesurfer.on('ready', function() {
                    ...
                    var pcm_identifier = the_player_id; // -- the pcm identifier to send via ajax
            ...
            function setup_media(pargs) {
                ...
                // console.info('--- setup_media()', cthis.attr('data-source'), o.cue,ajax_view_submitted, margs, loaded, cthis);
    ...
    $.fn.audiogallery = function(o) {
        ...
        this.each(function() {
            ...
            var busy = true;
            var i = 0;
            var ww, wh, tw, th, n_maindim // -- the navmain main dimension for scrolling
                , nc_maindim, sw = 0 // -- scrubbar width
                ,
                sh, spos = 0 // --  scrubbar prog pos
                ;
            ...
            function reinit() {
                ...
                for (i = 0; i < arr_menuitems.length; i++) {
                    ...
                    if(cthis.hasClass('skin-aura')){
                        aux+='<div class="menu-item-number">'+(i+1)+'</div>';
                    }
